...
const projects = [
  ...
  { id: 3, video: "https://www.youtube.com/embed/KEuNE2c66qg?si=rFdVLR0LXWCjPweZ", category: "video" },
  { id: 4, video: "https://drive.google.com/file/d/1Vtefr46sk9KBecaP8NS2ZwO-X0fkfU7k/preview", poster: thumbbi, category: "event" },
  { id: 5, image: project5, category: "website", link: "https://arqa.hbm.co.id/" },
  { id: 7, image: project7, category: "social" },
  { id: 8, video: "https://www.youtube.com/embed/3ujlV7nmw6c?si=Ptcpk43qGYFg88Wc", category: "video" },
  { id: 9, video: "https://drive.google.com/file/d/1YvUnzCYhZJPK5fD9Epaopyd61SicqcoN/preview", poster: thumblenovo, category: "event" },
  { id: 10, image: project8, category: "website", link: "https://kingsvault.io/" },
  { id: 11, image: project9, category: "website", link: "http://31.97.66.224:81/" },
  { id: 12, image: project10, category: "website", link: "https://bahasaplus.com/" },
  { id: 13, image: project11, category: "social" },
  { id: 14, video: "https://www.instagram.com/reel/C316YQJP1PA/embed", category: "video" },
  { id: 15, image: project12, category: "social" },
];
...
const Portfolio = () => {
  ...
  return (
    <div id="porto" className="mt-20 px-4 sm:px-6">
      ...
      {/* PROJECT CARD */}
      <div className="relative mt-10 flex flex-col justify-center items-center w-full">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="card w-full max-w-[750px] mx-auto flex justify-center overflow-hidden rounded-lg"
            style={{
              borderRadius: "20px",
          ...
          >
            <div
              className="flex justify-center items-center bg-black overflow-hidden w-full"
              style={{
